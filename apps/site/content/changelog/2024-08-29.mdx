...
To learn more and get started with TypedSQL, read our [docs](https://www.prisma.io/docs/orm/prisma-client/using-raw-sql/typedsql) and check our latest [blog post](https://www.prisma.io/blog/announcing-typedsql-make-your-raw-sql-queries-type-safe-with-prisma-orm) and [video](https://www.youtube.com/watch?v=ZwYcCti6CEs)!
...
Check our latest [post](https://www.prisma.io/blog/increased-security-static-ip-support-prisma-pulse) and go to the [platform console](https://console.prisma.io/) to get started.
