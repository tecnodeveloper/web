...
We’re continuing to improve the Prisma ORM experience with [Prisma ORM 5.22.0](https://github.com/prisma/prisma/releases/tag/5.22.0). In this release we focused on improving the `tracing` Preview feature and fix annoying bugs in metrics and connection pooling.

[More info available in our release notes!](https://github.com/prisma/prisma/releases/tag/5.22.0)
