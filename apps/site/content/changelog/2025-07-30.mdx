...
Your instance will be automatically deleted after 24 hours *but* you can claim it and put it into your [Prisma Console](https://console.prisma.io) account if you want to keep using it after that period. Learn more [in the docs](https://www.prisma.io/docs/postgres/introduction/npx-create-db).
